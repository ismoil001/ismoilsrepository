...
export default {
  ...
  section1_Title: "«EUROPRINT» tipografiyasi haqida",
  section1_Text: "\"EUROPRINT\" o'zbek bosmaxonasi - bu sizning biznesingizga\n" +
    "yuqori darajadagi professional yondashuv. Axir, sizning kompaniyangizning imidji\n" +
    "bunga bog'liq. Biz, o'zbek matbaa ijodiy uyi, Sizga eng yuqori darajadagi bosma dizayn va ishlab chiqarishni\n" +
  ...
  section1_Sub_Title: "\"EUROPRINT\" bosmaxonasi:",
  section1_Sub_Text1: "Katta tajriba",
  section1_Sub_Text2: "Eng yangi uskunalar",
  section1_Sub_Text3: "Keng doiradagi xizmatlar",
  section1_Sub_Text4: "Buyurtmaning eng tezkor bajarilishi",
  // Section 1 translate end


  // Section 2 translate start
  section2_Main_Title: "Nima uchun biz ?",
  section2_Sub_Title1: "Samaradorlik",
  section2_Text1: "Har qanday murakkablikdagi buyurtmalarni\n" +
    "tezkor hisoblash. Ofset usulida ishlash\n" +
    "24 soat davom etadi.",
  section2_Sub_Title2: "100% sifat",
  section2_Text2: "Eng yangi uskunalar, sifatli materiallar,\n" +
    "professional xodimlar.",
  section2_Sub_Title3: "Qulay narx",
  section2_Text3: "Xarajatlarni minimallashtirish bizga\n" +
    "bozor narxidan past narxlarda\n" +
    "raqobatdosh ustunlikni beradi.",
  section2_Sub_Title4: "Zamonaviy uskunalar",
  section2_Text4: "Bizning bosmaxona zamonaviy poligrafiya uskunalari bilan\n" +
    "jihozlangan ishlab chiqarish ustaxonasiga asoslanadi.",
  section2_Sub_Title5: "Dizayn ofisi va dizayn studiasi",
  section2_Text5: "Ular bizga g'oyalar bosqichida buyurtma\n" +
    "olishga va har qanday g'oyani birinchi darajali\n" +
    "tayyor mahsulotga tarjima qilishga imkon beradi.",
  ...
  section4_Text: "Lorem ipsum dolor sit amet, consectetur adipiscing elit.\n" +
