...
export default {
  ...
  section2_Sub_Title5: "Дизайн офис и дизайн студия",
  section2_Text5: "Они позволяют нам разместить заказ на стадии" +
    " идеи и перевести любую идею в готовый продукт.",
