      ...
      <div>
                ...
                <Col md={11}>
                  <Row>
                    <Col md={4}  className="text-center">
                      <CountTo className="lato-bold text-center number d-inline-block" to={628} speed={1000}/>
                    ...
                    <Col md={4} className="text-center">
                      <CountTo className="lato-bold text-center number" to={1500} speed={1000}/>
                      <span className="lato-bold number">+</span>
                      <p className="lato-regular  number-com">Bajarilgan buyurtmalar <br/>
                        soni</p>
                    </Col>
                    <Col md={4}  className="text-center">
                      <CountTo className="lato-bold text-center number" to={254} speed={1000}/>
                      <span className="lato-bold number">+</span>
        ...
        <section className="section7 position-relative" id="jamoa">
          ...
          <Container className='team_Carousel '>
            ...
            <Slider {...settings}>
              <div className=''>
                <Row className='team_Row mx-5'>
                  <Col xs={12} sm={12} md={4} lg={4} xl={4}>
                    <Card className='team_Card'>
                      <div className="d-flex align-items-center flex-column">
                        <div className='d-flex justify-content-center align-items-center img_Round'>
